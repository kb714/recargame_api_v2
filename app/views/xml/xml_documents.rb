class XmlDocuments
  ...
  # @return [Object]
  def initialize(amount, identifier, company, order, auth_code = nil)
    t = Time.now - 10800
  ...
  attr_accessor(:validate, :confirm, :reconfirm)
end